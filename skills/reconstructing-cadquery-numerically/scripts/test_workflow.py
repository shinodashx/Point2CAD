...
class WorkflowTests(unittest.TestCase):
    ...
    def test_reader_cli_report_indices_no_images_and_overwrite_protection(self):
        path = self.root / "cloud.npy"
        ...
        self.assertEqual(report["analysis_mode"], "numerical-only")
        self.assertEqual({p.name for p in out.iterdir()},
                         {"input_report.json", "points.npy", "source_indices.npy"})
        self.assertFalse(any("projection" in key for key in report))
